...
# Publications
\vspace{-0.1cm}
I have published **`r length(pubs$Type)`** peer-reviewed journal articles, chapters or books on Environmental Science topics. I have also presented my research at `r length(Talks$Title)` invited talks, and in several national and international conferences. 
