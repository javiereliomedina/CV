...
I am an engineer with 10+ years of research and teaching experience in environmental sciences, with a solid background in statistics, spatial data analysis, and modelling. I have done an MSc in Environmental Research, Modelling and Risk Assessment, and a PhD in Earth Science. My main research area is environmental science, with a particular interest in radon as a natural hazard. My prior experience is in soil pollution, hydrocarbon exploration, fractured media characterization and geological storage of $CO_2$. Nowadays, I am postdoc in Geoinformatics on Migration Modelling at Aalborg University (Denmark), and member of the research group Applied Marine Microbiology at Høgskulen på Vestlandet (Norway).
